      ...
      <section className="content">
        <article className="details">
          ...
          <div className="detail">
            ...
            <h6 className="color">색상 : {product.color}</h6>
        ...
        <div className="accordion">
          <ul className="lists">
            <li className="list">
              ...
              <div className="text">
                필링 테스트 4~4.5로 우수한 마찰 견뢰도를 보이고 있습니다. 그러나
                한 부분만 반복적으로 마찰에 노출되면 보풀이 발생할 수 있습니다.
                이럴 경우 소비자 상담실로 A/S 요청하시면 깨끗하게 제거해
                드립니다. * 마찰 견뢰도는 1~5등급으로 숫자가 클수록 보풀이 적게
                발생한다는 의미입니다. 울이 섞인 일반적인 스웨터가 대략 3~3.5급
                정도 받으면 합격 판정을받고 캐시미어나 앙고라 같이 헤어가 긴
                섬유는 2~3급 정도시 별도의 취급주의 택을 부착하여 출시 합니다.
              </div>
            </li>
            <li className="list">
              <div className="titleBox">
              ...
              <div className="text">
                ...
                <span className="subtext">
                  ...
                  1~3일 이내 받아보실 수 있습니다. (택배 영업소 사정에 따라 다소
                  차이가 있을 수 있습니다.)운송장번호 조회를 통해 배송과정을
                  확인하실 수 있습니다.일시 품절 및 제품 공급이 불가능 할 경우
                  결제일로부터 4영업일 이내 고객님께 안내 후 환불해드립니다.
                </span>
              ...
              return (
                <li key={item.id} className="list">
                  <div className="content">
                    <h3 className="review">{item.text}</h3>
                    <ul className="images">
                      {item.img &&
                        item.img.map(review => {
                          return (
                            <li className="image" key={review.id}>
                              <img
                                className="img"
                                src={review.imageUrl}
                                alt="리뷰이미지"
                  ...
                  <div className="userInfo">
                    ...
                    <p className="postTime">{item.postTime}</p>
                  </div>
                </li>
              );
            })}
